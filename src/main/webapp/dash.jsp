...
<br>
<h4 class="ps-3">Welcome Admin,</h4>
<hr>
<h5 class="ps-3">Rental List</h5>
<div class="p-3">
    <form action="updateReturnDate" method="post">
        <table class="table table-light table-hover px-auto">
            ...
            <%
                ...
                String query = "SELECT r.rentalId,r.user_id AS customerID,u.name AS customerName,r.movie_id AS movieID,p.name AS movieName,r.price,r.borrowDate,r.returnDate FROM  rentals r JOIN  users u ON r.user_id = u.id JOIN  products p ON r.movie_id = p.id WHERE r.returnDate IS NULL;\n";
            ...
            <tr>
                ...
                <td><button type="submit" class="btn btn-sm btn-primary" name="rentalid" value="<%=id%>">Return</button></td>
            </tr>
            <%
                }
            %>
